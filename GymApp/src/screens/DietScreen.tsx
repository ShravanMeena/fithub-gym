// Diet — your meal PLAN (what to eat, built for your goal). The day-by-day food
// log lives in the Food Diary (sidebar). Here you set your routine and get a plan.
...
export default function DietScreen({ navigation }: any) {
  ...
  return (
    <KeyboardScroll
      ...
      <Txt dim style={{ marginBottom: spacing(1.5) }}>What to eat, built for your goal.</Txt>

      {/* Quick actions */}
      <View style={{ flexDirection: 'row', gap: spacing(1.5), marginBottom: spacing(2) }}>
        <Button title="📷 Log food" onPress={() => navigation.navigate('Scan')} style={{ flex: 1 }} />
        <Button title="🍽️ Food diary" variant="ghost" onPress={() => navigation.navigate('FoodDiary')} style={{ flex: 1 }} />
      </View>
